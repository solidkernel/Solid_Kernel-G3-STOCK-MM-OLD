...
#ifdef CONFIG_LGE_LIMIT_FREQ_TABLE
	if(boot_mode == LGE_BOOT_MODE_FACTORY || boot_mode == LGE_BOOT_MODE_FACTORY2 || boot_mode == LGE_BOOT_MODE_FACTORY3 ||
	   boot_mode == LGE_BOOT_MODE_PIFBOOT || boot_mode == LGE_BOOT_MODE_PIFBOOT2 || boot_mode == LGE_BOOT_MODE_PIFBOOT3) {
